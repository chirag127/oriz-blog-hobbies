# Hobbies — `oriz-blog-hobbies`

> The joy of getting good at something — deep dives into the crafts and pastimes worth the hours.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-hobbies?style=flat)](https://github.com/chirag127/oriz-blog-hobbies/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-hobbies)](https://github.com/chirag127/oriz-blog-hobbies/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-hobbies/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-hobbies/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Hobbies** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A hobbies blog exploring crafts, collecting, and pastimes — starter guides and deep dives for people who love getting good at things.

- **Live site:** https://hobbies-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-hobbies
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-hobbies/ — the canonical, always-current site is **https://hobbies-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-hobbies/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>hobbies-blog.oriz.in"]
...
oriz-blog-hobbies/
├── src/
│   ├── content/blog/       # the hobby guides (MDX/Markdown)
