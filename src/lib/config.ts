...
export const SITE_CONFIG: BlogConfig = {
  title: 'The Bench — Hobbies & Gear',
  description: 'Honest starter guides and gear notes for film photography, mechanical keyboards, woodworking, and more — by Chirag Singhal.',
  url: 'https://hobbies-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-hobbies') as `${string}/${string}`,
